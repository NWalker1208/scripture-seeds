...
class HighlightTextWord extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var _style = style ?? DefaultTextStyle.of(context).style;

    var color = _backgroundColor.withOpacity(0);
    if (selected) {
      color = Color.lerp(_backgroundColor, _highlightColor, 0.5);
    } else if (highlighted) color = _highlightColor;
    ...
    return GestureDetector(
      ...
      onLongPressMoveUpdate: (details) =>
          onSelectionUpdate?.call(details.globalPosition),
